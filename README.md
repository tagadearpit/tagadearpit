<div align="center">
  <img src="./assets/profile-header.svg" width="100%" alt="Arpit Tagade — Full-Stack AI Engineer and Hardware Developer" />
</div>
...
<table>
  <tr>
    <td width="50%" valign="top">
      <h3>Monika AI</h3>
      <p><strong>Multimodal AI companion platform</strong></p>
      <p>
      ...
      <p><strong>Stack:</strong> Node.js, Express, MongoDB, Gemini API, Firebase, JWT</p>
      <p>
    ...
    <td width="50%" valign="top">
      <h3>Neosis</h3>
      <p><strong>Real-time messaging and browser calling platform</strong></p>
      <p>
      ...
      <p><strong>Stack:</strong> Java, Spring Boot, React, MongoDB, STOMP, WebRTC, OAuth 2.0</p>
      <p>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <p><strong>Responsive portfolio and project showcase</strong></p>
      <p>
    ...
    <td width="50%" valign="top">
      <h3>CandyRobot</h3>
      <p><strong>AI-connected embedded robotics platform</strong></p>
      <p>
      ...
      <p><strong>Stack:</strong> ESP32, C++, Arduino, OLED, servo control, Gemini API</p>
      <p><strong>Focus:</strong> cloud AI ↔ embedded control ↔ physical interaction</p>
    </td>
  </tr>
</table>
...
<div align="center">
  <sub>Building reliable systems across software, AI, and physical hardware.</sub>
</div>
